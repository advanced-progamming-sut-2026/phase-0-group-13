...
public class PlantFactory {
    ...
    private PlantCategory determineCategory(String catStr) {
        ...
        switch (catStr.toLowerCase().trim()) {
            case "sun producers": return PlantCategory.SUN_PRODUCER;
            case "shooters":      return PlantCategory.SHOOTER;
            case "lobbers":       return PlantCategory.LOBBER;
            case "explosives":    return PlantCategory.EXPLOSIVE;
            case "wall-nuts":     return PlantCategory.WALL_NUT;
            case "melee":         return PlantCategory.MELEE;
            default:              return PlantCategory.SHOOTER;
        }
    }

...
public class Collection {
    ...
    public Result upgradeSeedSlots() {
        if (this.maxSeedSlots < 10) { // یادم نمیاد چند تا بود ، حوصله ندارم داک و ببینم الان دقیقش ، 10 گذاشتم
            this.maxSeedSlots++;
            return new Result(true, "Seed slots upgraded! Current slots: " + this.maxSeedSlots, this.maxSeedSlots);
        }
